...
import static com.enes.marathonproject.exception.ErrorType.BAD_REQUEST_ERROR;
...
public class GlobalExceptionHandler {
     ...
     *
     */
    @ExceptionHandler(marathonProjectException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handlerSatisException(marathonProjectException satisException){
